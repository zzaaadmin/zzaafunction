...
{
    public static class WhiteCasePracticesForGoogle
    {
        ...
        [FunctionName("WhiteCasePracticesForGoogle")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            {
                case "FindIntent":
                    string practice = (string)data.result.parameters.practice;//data.request.intent.slots["practice"].value;
